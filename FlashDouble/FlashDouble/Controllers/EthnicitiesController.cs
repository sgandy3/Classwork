...
namespace FlashDouble.Controllers
{
    public class EthnicitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EthnicityID,Asian,African,Caucasian,EasternEurope,EastIndian,Hispanic,MiddleEastern,NativeAmerican,PacificIslander,Other,NoAnswer")] Ethnicity ethnicity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EthnicityID,Asian,African,Caucasian,EasternEurope,EastIndian,Hispanic,MiddleEastern,NativeAmerican,PacificIslander,Other,NoAnswer")] Ethnicity ethnicity)
        {
            if (ModelState.IsValid)
            {
